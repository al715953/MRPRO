...
class UniverseReductionStrategy:
    ...
    def reduce(self, history, config, verbose=True):
        ...
        excluded_pool, sniper_msg = self.filters.get_sniper_exclusion(history, threshold=threshold)
        ...
        if verbose:
            ...
            if excluded_pool:
                ...
                print(f"   🛡️  Sniper E1: Silencio de Radio (Sin exclusiones de alta certeza).")
